<?php
	...
	$url='https://api.openweathermap.org/data/3.0/onecall?lat=' . $_REQUEST['lat'] . '&lon=' . $_REQUEST['lng'] . '&exclude=minutely,hourly,daily,alerts&appid=e901305dcbd8c73cea96c1a966afff9a';
